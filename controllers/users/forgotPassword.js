...
var forgotPassword1stStep = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var email, randomNumbers, message, subject, text, saveRandomNumbers, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                email = req.body.email;
                randomNumbers = Array.from({ length: 8 }, function () {
                    return Math.floor(Math.random() * 10);
                });
                message = "<div>".concat(randomNumbers, "</div>");
                subject = "Password Reset";
                text = "".concat(randomNumbers);
                (0, nodemailer_1.default)(message, email, subject, text);
                saveRandomNumbers = function (randomNumbers) {
                    return new Promise(function (resolve, reject) {
                        var query = "INSERT INTO forgot_password_codes (number1, number2, number3, number4, number5, number6, number7, number8) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                        var values = randomNumbers;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, saveRandomNumbers(randomNumbers)];
            case 2:
                _a.sent();
